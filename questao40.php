...
<head>
    ...
    <title>Companhia de Seguros</title>
</head>
<body>
    <h1>Companhia de Seguros</h1>
    <h2>40.Uma Companhia de Seguros possui nove categorias de seguro baseadas na idade e ocupação do segurado. Somente
